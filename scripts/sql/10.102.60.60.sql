...
-- ('WS','SearchPolicyByCustomerId', 'http://10.102.60.20:8080/PolicyDataService/rest/searchPolicy/SearchPolicyByCustomerId',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyPremium', 'http://10.102.60.112:8280/interfaceCsv/rest/calculate/policyPremium/1.0',1,current_timestamp,current_timestamp,'name','name') ,
...
('WS','PolicyDetailsOL', 'http://10.102.60.60:8080/PolicyDataService/PolicyDetailsOL',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetRiderDetial', 'http://10.102.60.60:8080/PolicyDataService/GetRiderDetial',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetPaymentHistory', 'http://10.102.60.60:8080/PolicyDataService/GetPaymentHistory',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetBeneficiaryInfo', 'http://10.102.60.60:8080/PolicyDataService/GetBeneficiaryInfo',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyDetailsUnitLink', 'http://10.102.60.60:8080/PolicyDataService/PolicyDetailsUnitLink',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyDetailsCL', 'http://10.102.60.60:8080/PolicyDataService/PolicyDetailsCL',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','GetLoanPremium', 'http://10.102.60.60:8080/PolicyDataService/GetLoanPremium',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetCoverageOverview', 'http://10.102.60.60:8080/PolicyDataService/GetCoverageOverview',1,current_timestamp,current_timestamp,'name','name'),
('WS','ClaimInquiry', 'http://10.102.60.112:8280/interfaceCsv/rest/claim/claimInquiry/1.0',1,current_timestamp,current_timestamp,'name','name'),
('WS','ClaimDetail', 'http://10.102.60.112:8280/interfaceCsv/rest/claim/claimDetail/1.0',1,current_timestamp,current_timestamp,'name','name'),
('WS','NextPayPeriod', 'http://10.102.60.60:8080/PolicyDataService/NextPayPeriod',1,current_timestamp,current_timestamp,'name','name'),
('WS','ActualValuePolicy', 'http://10.102.60.60:8080/PolicyDataService/actualValuePolicy',1,current_timestamp,current_timestamp,'name','name'),
('WS','POL_DB_01_SearchPolicyByCustomerId', 'http://10.102.60.60:8080/PolicyDataService/SearchPolicyByCustomerId',1,current_timestamp,current_timestamp,'name','name');
