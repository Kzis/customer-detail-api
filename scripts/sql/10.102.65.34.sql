...
VALUES('WS','getAccessToken', 'http://10.102.65.114:8280/token',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','SearchByCitizenId', 'http://10.102.65.114:8280/interfaceCsv/rest/searchCustomerByCitizenId/1.0',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','SearchByCustomerName', 'http://10.102.65.114:8280/interfaceCsv/rest/searchCustomerByCustomerName/1.0',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','SearchByPolicyNo', 'http://10.102.65.114:8280/interfaceCsv/rest/searchCustomerByPolicyNo/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','SearchByCustomerRef', 'http://10.102.65.114:8280/interfaceCsv/rest/searchCustomerByPartyId/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupSubDistrictCode', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupSubDistrictCode/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupEducationLevel', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupEducationLevel/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupIncomeRange', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupIncomeRange/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupOccupation', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupOccupation/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupMaritalStatus', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupMaritalStatus/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupParticipantRole', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupParticipantRole/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupBloodGroup', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupBloodGroup/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupReligion', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupReligion/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupCountryCode', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupCountryCode/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','LookupAll', 'http://10.102.65.114:8280/interfaceCsv/rest/LookupAll/1.0',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','SearchPolicyByCustomerId', 'http://10.102.65.34:8080/PolicyDataService/SearchPolicyByCustomerId/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyPremium', 'http://10.102.65.114:8280/interfaceCsv/rest/calculate/policyPremium/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyLoan', 'http://10.102.65.114:8280/interfaceCsv/rest/policy/policyLoan',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','PolicyList', 'http://10.102.65.34:8080/PolicyDataService/SearchPolicyByCustomerId/1.0',1,current_timestamp,current_timestamp,'name','name') ,
...
('WS','CalculateLoan', 'http://10.102.65.114:8280/interfaceCsv/rest/calculate/calculateLoan/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','CalculateBenefit', 'http://10.102.65.34:8080/interfaceCsv/rest/calculate/calculateBenefit/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','CalculateCancel', 'http://10.102.65.34:8080/interfaceCsv/rest/calculate/calculateCancel/1.0',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetLoanPremium', 'http://10.102.65.34:8080/PolicyDataService/GetLoanPremium',1,current_timestamp,current_timestamp,'name','name') ,
('WS','DisplayPolicyList', 'http://10.102.65.34:8080/PolicyDataService/DisplayPolicyList',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyDetailsOL', 'http://10.102.65.34:8080/PolicyDataService/PolicyDetailsOL',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetRiderDetial', 'http://10.102.65.34:8080/PolicyDataService/GetRiderDetial',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetPaymentHistory', 'http://10.102.65.34:8080/PolicyDataService/GetPaymentHistory',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetBeneficiaryInfo', 'http://10.102.65.34:8080/PolicyDataService/GetBeneficiaryInfo',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyDetailsUnitLink', 'http://10.102.65.34:8080/PolicyDataService/PolicyDetailsUnitLink',1,current_timestamp,current_timestamp,'name','name') ,
('WS','PolicyDetailsCL', 'http://10.102.65.34:8080/PolicyDataService/PolicyDetailsCL',1,current_timestamp,current_timestamp,'name','name') ,
-- ('WS','GetLoanPremium', 'http://10.102.65.34:8080/PolicyDataService/GetLoanPremium',1,current_timestamp,current_timestamp,'name','name') ,
('WS','GetCoverageOverview', 'http://10.102.65.34:8080/PolicyDataService/GetCoverageOverview',1,current_timestamp,current_timestamp,'name','name') ,
('WS','ClaimInquiry', 'http://10.102.65.114:8280/interfaceCsv/rest/claim/claimInquiry/1.0',1,current_timestamp,current_timestamp,'name','name'),
('WS','ClaimDetail', 'http://10.102.65.114:8280/interfaceCsv/rest/claim/claimDetail/1.0',1,current_timestamp,current_timestamp,'name','name'),
('WS','NextPayPeriod', 'http://10.102.65.34:8080/PolicyDataService/NextPayPeriod',1,current_timestamp,current_timestamp,'name','name'),
('WS','ActualValuePolicy', 'http://10.102.65.34:8080/PolicyDataService/actualValuePolicy',1,current_timestamp,current_timestamp,'name','name'),
('WS','POL_DB_01_SearchPolicyByCustomerId', 'http://10.102.65.34:8080/PolicyDataService/SearchPolicyByCustomerId/1.0',1,current_timestamp,current_timestamp,'name','name');
...
('900-5611',1,'json',1,current_timestamp,current_timestamp,'name','name'),
